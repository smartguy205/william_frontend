            ...
            <div className="container">
                ...
                <div className='d-flex flex-column justify-content-center bg-light p-4'>
                    <div className="row">
                        ...
                        <h6 className='col-12 col-md-6 col-lg-3'>Word/minute: {user?.wpm ?? '---'}</h6>
                        <h6 className='col-12 col-md-6 col-lg-3'>Typing Accuracy: {user?.taccuracy ?? '---'}</h6>
                        ...
                        <h6 className='col-12 col-md-6 col-lg-3'>Test Type: {user?.testType}</h6>
                    </div>
                    {
                        data.map((paper, i) => {
                            // 57 == ASCII of 9,
